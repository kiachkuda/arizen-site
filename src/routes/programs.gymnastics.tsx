...
function GymPage() {
  return (
    <>
      <Helmet>
        <title>{"Gymnastics — Ascend Academy"}</title>
        <meta name="description" content={"Beginner to advanced gymnastics classes for ages 5–17. Safety-first coaching, flexibility, strength and performance."} />
        <meta property="og:title" content={"Gymnastics Program"} />
        <meta property="og:description" content={"Beginner to advanced gymnastics for kids."} />
        <meta property="og:image" content={imgGym} />
        <meta property="og:url" content={"/programs/gymnastics"} />
        <link rel="canonical" href={"/programs/gymnastics"} />
      </Helmet>
