...
function SoccerPage() {
  return (
    <>
      <Helmet>
        <title>{"Soccer Academy — Ascend"}</title>
        <meta name="description" content={"Youth soccer training from grassroots to elite competitive levels. Age groups, schedules, and coaching methodology."} />
        <meta property="og:title" content={"Soccer Academy"} />
        <meta property="og:description" content={"Elite soccer training for kids 5–17."} />
        <meta property="og:image" content={imgSoccer} />
        <meta property="og:url" content={"/programs/soccer"} />
        <link rel="canonical" href={"/programs/soccer"} />
      </Helmet>
      ...
      <section className="py-24 px-6">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 gap-4">
          {[g1, g5, g4, imgSoccer, g1, g5].map((src, i) => (
