...
function DigitalPage() {
  return (
    <>
      <Helmet>
        <title>{"Digital Skills — Ascend Academy"}</title>
        <meta name="description" content={"Coding, robotics, AI, game design and creative tech for children. Project-based learning that builds tomorrow's creators."} />
        <meta property="og:title" content={"Digital Skills Program"} />
        <meta property="og:description" content={"Coding, robotics, AI and creative tech for kids."} />
        <meta property="og:image" content={imgDigital} />
        <meta property="og:url" content={"/programs/digital"} />
        <link rel="canonical" href={"/programs/digital"} />
      </Helmet>
