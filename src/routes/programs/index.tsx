...
export const Route = createFileRoute("/programs/")({
  head: () => ({
    meta: [
      { title: "Programs — Ascend Academy" },
      { name: "description", content: "Explore our core programs: Soccer Academy, Gymnastics, Digital Skills and Home Schooling for kids ages 5–17." },
      { property: "og:title", content: "Our Programs" },
      { property: "og:description", content: "Soccer, Gymnastics, Digital Skills and Home Schooling programs." },
