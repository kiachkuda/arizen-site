...
function HomeschoolPage() {
  return (
    <>
      <Helmet>
        <title>{"Home Schooling — Ascend Academy"}</title>
        <meta name="description" content={"Accredited home schooling solutions for kids ages 5–17. Personalised curriculum, certified tutors, live online classes and flexible pacing."} />
        <meta property="og:title" content={"Home Schooling Program"} />
        <meta property="og:description" content={"Accredited, personalised home schooling for ages 5–17."} />
        <meta property="og:image" content={imgHome} />
        <meta property="og:url" content={"/programs/homeschool"} />
        <link rel="canonical" href={"/programs/homeschool"} />
      </Helmet>
